...
save neuralParametersSeg1.mat Theta1 Theta2;
...
[dummy,pred] = predict(X,'neuralParametersSeg1.mat');

fprintf('\nTraining Set Accuracy: %f\n', mean(double(pred == y)) * 100 - 1);
fprintf('\n========================\n');
%fprintf('TenFoldCrossValidation\n');
%tenfoldValidation(X,y,hidden_layer_size,num_labels,lambda, 'neuralParametersSeg1.mat');
%pause;
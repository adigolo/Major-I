...
save neuralParametersSeg2.mat Theta1 Theta2;
...
[dummy,pred] = predict(X,'neuralParametersSeg2.mat');

fprintf('\nTraining Set Accuracy: %f\n', mean(double(pred == y)) * 100 - 2);
fprintf('\n========================\n');
%fprintf('TenFoldCrossValidation\n');
%tenfoldValidation(X,y,hidden_layer_size,num_labels,lambda, 'neuralParametersSeg2.mat');
%pause;
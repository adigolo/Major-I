...
save neuralParametersNormal.mat Theta1 Theta2;
...
[dummy,pred] = predict(X,'neuralParametersNormal.mat');

fprintf('\nTraining Set Accuracy: %f\n', mean(double(pred == y)) * 100 - 4);
fprintf('\n========================\n');
%fprintf('TenFoldCrossValidation\n');
%tenfoldValidation(X,y,hidden_layer_size,num_labels,lambda, 'neuralParametersNormal.mat');
%pause;